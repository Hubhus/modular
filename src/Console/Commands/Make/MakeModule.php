...
class MakeModule extends Command
{
    ...
    public function handle()
    {
        ...
        if ($this->confirm("Run <kbd>composer update {$this->composer_name}</kbd>", true)) {
            Process::tty()->run(['composer', 'update', $this->composer_name]);
        } else {
            $this->line("Please run <kbd>composer update {$this->composer_name}</kbd> manually");
        }
    ...
    protected function getStubs(): array
    {
        return [
            ...
            'tests/Feature/StubClassNamePrefixTest.php'                                => $this->pathToStub('FeatureTest.php'),
            ...
            'resources/views/sample.blade.php'                                         => $this->pathToStub('view.blade.php'),
            'src/Models/.gitkeep'                                                      => $this->pathToStub('.gitkeep'),
