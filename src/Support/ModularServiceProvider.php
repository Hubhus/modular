...
class ModularServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Registration of migrations and policies is performed in module service-providers.
    ...
    {
        // Config is hard-coded, so no need to publish it
        // $this->publishVendorFiles();
        $this->bootPackageCommands();
        // Booting of routes, views and components is performed in each module service provider
        // $this->bootRoutes();
    ...
    protected function registerPolicies(Gate $gate): void
    {
        $this->autoDiscoveryHelper()
            ...
            ->each(function(SplFileInfo $file) use ($gate) {
                ...
                $namespaced_policy = rtrim(
                    $module->namespaces->first(),
                    '\\'
                ) . '\\Policies\\' . $namespaced_model . 'Policy';
